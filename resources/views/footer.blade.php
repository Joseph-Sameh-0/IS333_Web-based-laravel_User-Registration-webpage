<footer style="background-color:#0A131A; padding: 40px 20px; margin-top: 40px; border-top: 1px solid #e7e7e7;">
    <div style="max-width: 1200px; margin: 0 auto; display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 30px;">
        <!-- Registration Form -->
        <div>
            <h3 style="color: #FFFFFF; margin-bottom: 15px;">Registration Form</h3>
        </div>
        ...
        <div>
            ...
            <ul style="list-style: none; padding: 0; margin: 0;">
                ...
                <li style="margin-bottom: 8px;"><a href="#" style="color: #0376b8; text-decoration: none;">Terms of Service</a></li>
                <li style="margin-bottom: 8px;"><a href="#" style="color: #0376b8; text-decoration: none;">Contact Us</a></li>
            </ul>
        </div>
        ...
        <div>
            ...
            <p style="color: #FFFFFF; margin: 5px 0;">Email: support@site.com</p>
            <p style="color: #FFFFFF; margin: 5px 0;">Phone: 0123456789</p>
        </div>
